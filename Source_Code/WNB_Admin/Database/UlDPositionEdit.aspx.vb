Partial Public Class UlDPositionEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Me.IsPostBack = False Then
            ...
            Try
                ...
                If Not Request.QueryString("PosID") Is Nothing Then
                    hidPosID.Value = Request.QueryString("PosID")
                    GetPostionDetails()
                End If
    ...
    Private Sub GetULDRef()
        Try
            ...
            dtULDref = go_Bo.Get_ULDDefiniton("26", hidTableId.Value)
    ...
    Private Sub GetPostionDetails()
        Try
            ...
            dtPositionDetails = go_Bo.Get_ULDPosition(hidTableId.Value, lblAircraft.Text.Trim, Convert.ToInt32(hidPosID.Value))
            If (dtPositionDetails.Rows.Count > 0) Then
                txtPosition.Text = dtPositionDetails.Rows(0)("pos_name")
                TxtMaxLoad.Text = dtPositionDetails.Rows(0)("max_pos_load")
                TxtPosArm.Text = dtPositionDetails.Rows(0)("pos_arm")
                ddlUldRef.Text = dtPositionDetails.Rows(0)("uld_ref_cl_id")
    ...
    Protected Sub btnsave_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnsave.Click
        Try
            ...
            If (hidPosID.Value = "") Then
                hidPosID.Value = "0"
            End If
            intresult = go_Bo.CreateUpdateAirCraftPostion(Convert.ToInt32(hidPosID.Value), lblAircarftConfig.Text.Trim, txtPosition.Text, _
    ...
    Protected Sub btnCancel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnCancel.Click
        Try
            Response.Redirect("UnderFloorPostionDetail.aspx?FID=" & hidFunctionId.Value & "&TID=" & hidTableId.Value)
        Catch ex As Exception
            ScriptManager.RegisterStartupScript(Me, GetType(System.String), "Message", _
