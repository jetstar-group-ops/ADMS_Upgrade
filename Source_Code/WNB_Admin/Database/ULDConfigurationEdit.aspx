<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ULDConfigurationEdit.aspx.vb" MasterPageFile ="~/MasterPage.Master" Inherits="WNB_Admin.ULDConfigurationEdit" %>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border: solid 1px Black;">
                                                                    <tr style="height: 30px;">
                                                                        ...
                                                                        <td style="width: 10%;">
                                                                            <asp:Label ID="lblAircraft" runat="server" AutoPostBack="true" 
                                                                                CssClass="Label"  Height="20px" Width="200px" 
                                                                                style="vertical-align :middle" Font-Bold="True" />
                                                                    ...
                                                                    <tr style="height: 30px;">
                                                                        <td class="Label" style="width: 10%; text-align: right;">
                                                                            Position </td>
                                                                        <td style="width: 10%;">
                                                                            <asp:DropDownList ID="ddlUldPosition" runat="server" AutoPostBack="true" 
                                                                                DataTextField="Pos_name" DataValueField="Pos_name" Width="200px">
                                                                            </asp:DropDownList>
                                                                            </td>
                                                                        <td class="Label" style="width: 10%; text-align: right;">
                                                                            &nbsp;</td>
                                                                    ...
                                                                    <tr style="height: 30px;">
                                                                        ...
                                                                        <td style="width: 10%;">
                                                                            ...
                                                                            DataTextField="ULDDefinition" DataValueField ="ULDDefinition" Width="200px" 
                                                                            >
                                                                            </asp:DropDownList>
                                                                        </td>
                                                                        <td class="Label" style="width: 10%; text-align: right;">
