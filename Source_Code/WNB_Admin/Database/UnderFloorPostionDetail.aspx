<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UnderFloorPostionDetail.aspx.vb"
    MasterPageFile="~/MasterPage.Master" Inherits="WNB_Admin.UnderFloorPostionDetail" %>
                                                                            ...
                                                                            <div id="DivUpper" style="overflow: auto;" runat="server">
                                                                                <asp:GridView ID="gvPosition" runat="server" AutoGenerateColumns="False" CellPadding="2"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField HeaderText="ULDRef" DataField="Uld_ref_cl_id" />
                                                                                        <asp:BoundField HeaderText="Max Load" DataField="Max_pos_load" />
                                                                                        <asp:BoundField HeaderText="Position Arm" DataField="Pos_arm" />
                                                                                        <asp:TemplateField HeaderText="Action">
                                                                                        <ItemTemplate >
                                                                                            <asp:HiddenField runat="server" ID="hidAirCraftPosID"  Value='<%# Container.DataItem("aircraft_config_pos_id")%>'  />
