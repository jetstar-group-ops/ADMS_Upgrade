<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ADMS_AptMaxExp.aspx.vb" Inherits="WNB_Admin.ADMS_AptMaxExp" MasterPageFile="~/ADMS/ADMS_Master.Master"
    Title="AirportMax Codes" %>
            ...
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                <tr>
                                    <td bgcolor="#DADADA" align="center">
                                        &nbsp;
                                        <asp:Label ID="lblListTitle" runat="server" Text="Airport Max Code" 
                                            Font-Bold="True" Font-Size="16pt"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend><span class="ReportTitle" style="font-size: small;">Create / Update Airport 
                                    Max Code</span></legend>
